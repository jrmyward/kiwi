namespace :db do
  ...
  task :seed_events => :environment do
    ...
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 1", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 2", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 3", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 4", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 5", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 6", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 7", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 8", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 9", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 10", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
    Event.create! time_format: '', datetime: 2.days.from_now, local_date: 2.days.from_now, name: "Melon Day 11", description:"lorem ipsum", user: "rails", upvote_names: ['rails', 'ruby', 'php'], location_type: 'national', country: 'CA', is_all_day: false, subkast: 'ST'
