json.array!(@events) do |event|
  json.extract! event, :details, :name, :created_at, :updated_at, :local_time, :local_date, :tv_time, :is_all_day, :time_format, :user, :country, :location_type, :subkast, :comment_count
