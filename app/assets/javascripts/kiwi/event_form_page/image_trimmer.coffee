class FK.ImageTrimmer.ImageTrimmerController extends Marionette.Controller
  initialize: (opts) ->
    @model = new FK.ImageTrimmer.ImageCalculator()
    @view = new FK.ImageTrimmer.ImageTrimmerLayout(controller: @, model: @model)
...
class FK.ImageTrimmer.ImageCalculator extends Backbone.Model
  defaults: () =>
    height: 0
    width: 0
    min_width: 0
